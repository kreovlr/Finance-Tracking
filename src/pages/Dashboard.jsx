...
function Dashboard() {
  const { income, expenses, balance, transactions, budgets, formatCurrency } = useFinance();
  ...
  return (
    <div>
      ...
      <div className="grid gap-6 md:grid-cols-3"><Card title="Income" amount={income} formatCurrency={formatCurrency} /><Card title="Expenses" amount={expenses} formatCurrency={formatCurrency} /><Card title="Balance" amount={balance} formatCurrency={formatCurrency} /></div>
